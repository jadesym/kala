...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { age: @instructor.age, email: @instructor.email, first_name: @instructor.first_name, last_name: @instructor.last_name, password: @instructor.password, phone_number: @instructor.phone_number, texting: @instructor.texting }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { age: @instructor.age, email: @instructor.email, first_name: @instructor.first_name, last_name: @instructor.last_name, password: @instructor.password, phone_number: @instructor.phone_number, texting: @instructor.texting }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
